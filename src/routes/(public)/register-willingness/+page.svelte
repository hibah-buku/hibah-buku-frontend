			...
			{#if form?.success}
				<div class="rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-green-800">
                    <div class="flex gap-2 items-center mb-2">
                        <Icon icon="lucide:circle-check" class="w-8 h-8"/>
					    <strong class="text-xl">Berhasil!</strong>
                    </div>
                    Data kesediaan Anda telah dikirim. Tim admin akan segera memproses akun Anda.
				</div>
			{:else if form?.errors}
				<div class="rounded-lg border border-red-200 bg-red-50 px-4 py-3 text-red-800">
					<div class="flex gap-2 items-center mb-2">
                        <Icon icon="tdesign:error-triangle" class="w-8 h-8"/>
                        <strong>Gagal!</strong>
                    </div>
			...
			<form method="POST" use:enhance class="space-y-8">
					...
					<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
						...
						<div>
							<label for="main_author_email" class="mb-1 block text-sm font-medium text-gray-700"
								>Email Aktif <span class="text-lg text-red-600">*</span></label
							>
							<input
								type="email"
						...
						<div>
							<label
								...
								>Institusi / Universitas <span class="text-lg text-red-600">*</span></label
							>
							<input
								type="text"
						...
						<div>
							<label for="main_author_phone" class="mb-1 block text-sm font-medium text-gray-700"
								>Nomor Telepon (WhatsApp) <span class="text-lg text-red-600">*</span></label
							>
							<input
								type="tel"
				...
				<div class="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
					<h3 class="mb-3 text-lg font-medium text-gray-700">
                        <span class="mr-2 rounded bg-blue-100 px-2.5 py-0.5 text-xs font-semibold text-blue-800">Wajib</span>
                        Rekan Penulis 1
                    </h3>
					<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                        ...
                        <div>
							<label for="co_author_1_institution" class="mb-1 block text-sm font-medium text-gray-700"
								>Institusi <span class="text-lg text-red-600">*</span>
							</label>
                            <input
                                type="text"
				...
				<div class="border-b border-gray-200 pb-6">
					<h2 class="mb-4 flex items-center text-lg font-medium text-gray-900">
						<span class="mr-2 rounded bg-gray-100 px-2.5 py-0.5 text-xs font-semibold text-gray-800"
							>Opsional</span
						>
					...
					<!-- Co-Author 2 -->
					<div class="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
						<h3 class="mb-3 text-sm font-semibold text-gray-700">Rekan Penulis 2 <span class="text-gray-400">(Opsional)</span></h3>
						<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
							<input
								type="text"
					...
					<!-- Co-Author 3 -->
					<div class="mb-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
						<h3 class="mb-3 text-sm font-semibold text-gray-700">Rekan Penulis 3 <span class="text-gray-400">(Opsional)</span></h3>
						<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
							<input
								type="text"
					...
					<div class="rounded-lg border border-gray-200 bg-gray-50 p-4">
						<h3 class="mb-3 text-sm font-semibold text-gray-700">Rekan Penulis 4 <span class="text-gray-400">(Opsional)</span></h3>
						<div class="grid grid-cols-1 gap-4 md:grid-cols-3">
							<input
								type="text"
				...
				<div class="pt-4">
					<button
						type="submit"
						class="w-full rounded-lg bg-blue-600 px-6 py-3 font-medium text-gray-100 transition-colors duration-200 hover:bg-blue-800 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none cursor-pointer"
					>
						Kirim Konfirmasi Kesediaan
					</button>
				</div>
			</form>
		</div>
